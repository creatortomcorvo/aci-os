...
- Closed Gate 1 after Tom supplied Gate 1 Resolution Record v1.0. Created `00_foundation/Foundation_Map_v1.0.md` and moved the record to `00_foundation/gate_1_resolution_record_v1.0.md`. Foundation Map v1.0 integrates the five decisions: incentives/discipline split, AI risk/control rows, third-party/M&A lens, Annex A 12-to-7 crosswalk with no orphans, and OFAC as the eighth anchor. Updated phase: Stage 2 - Sanctions Agent v1 toward Gate 2; Stage 4 journal continues in parallel; Stage 0a closed; Stage 0b checked only at Stage 3/5 or before external/commercial steps.

## Instruction Sync - 2026-07-04

- Made `Project_Instructions_v0_4.md` the current standalone instruction text and added the first-line conflict rule: this file wins, flag contradictions, do not average.
- Copied the exact same text into `AGENTS.md` for Codex and `00_Project/PROJECT_DISCIPLINE.md` for repo-level project discipline.
- Verified the three instruction files are identical and reflect Gate 1 closed / Foundation Map v1.0 done.

## Gate 2 Run v0.1 - 2026-07-04

- Integrated career-pattern mining into `06_Testing/Career_Patterns_v0.1.md` and corrected incoming path references to the actual repo layout.
- Created `06_Testing/Gate_2_Sanctions_Test_Library_v0.1.md` with sanctions TC1-TC10 and the Gate 2 procedure.
- Ran the first formal Gate 2 specification run against the frozen current agent documents; no agent behavior was changed before the run.
