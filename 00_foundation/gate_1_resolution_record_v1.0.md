...
**Date decided:** 04 July 2026
**Decided by:** Tomasz Kruk
**Status:** Gate 1 CLOSED. All five decisions are closed and Foundation Map v1.0 has absorbed the mechanical drafting items. No further Gate 1 decisions are required.
...
Consequence management lives twice by design: board-level accountability and tone (Element 1, Governance & Tone) and post-finding disciplinary mechanics (Element 7, Response & Remediation). Documented as a deliberate dual-home with a footnote in the Foundation Map. Rationale: USSG Section 8B2.1 itself splits the concept; forcing a single home would fail the crosswalk against the anchor that defines it.

**D2 - AI/emerging-technology risk: YES - risk row in Element 2, control row in Element 3. No new element.**

Per ECCP (Sept 2024): AI is a risk to be assessed (E2) and a control medium to be governed (E3), including monitoring AI against intended purpose and a baseline of human decision-making. The control-medium dimension (Core Spec Section 9) reinforces: AI is how controls are implemented, not a program pillar.
...
Rationale: Agent #1 is Sanctions; a Foundation Map excluding the sanctions regulator's own compliance framework would be indefensible in front of exactly the practitioners the product serves. Anchor set is now final at eight: DOJ ECCP (2024); FCPA Resource Guide + 2025 enforcement guidelines; UK Bribery Act six principles; ECCTA failure-to-prevent-fraud; ISO 37301/37001; USSG Section 8B2.1/OIG; OECD Good Practice Guidance; OFAC Framework. Second-ring sources (cited, not crosswalked): EU AI Act, ISO/IEC 42001, GDPR.

## Mechanical Task - Completed

Foundation Map v1.0: add the OFAC crosswalk column; insert D1 and D4 footnotes; insert the D3 lens definition paragraph; add the D2 rows to Elements 2 and 3; attach Annex A (12->7 table) as decided. Completed by Codex in `00_foundation/Foundation_Map_v1.0.md`; Gate 1 marked CLOSED in `00_Project/PROJECT_DISCIPLINE.md` and `00_Project/WHERE_ARE_WE.md`.
