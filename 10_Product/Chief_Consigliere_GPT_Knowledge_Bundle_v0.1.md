...
# The Third-Party Lifecycle â€” The Kruk Method
...
**Elements:** E2 (Risk Assessment) Â· E3 (Standards & Controls) Â· E6 (Monitoring & Data) â€” this document is the third-party cross-cutting lens, written out in full.
...
- **before** â€” because nobody asked why this third party is needed at all;
- **during** â€” because nobody watched after onboarding;
- **after** â€” because nobody managed the ending: final payments, old invoices, data, and what the file must show years later.

Enforcement reality supports this focus: most major corruption cases involve an intermediary â€” an agent, distributor, consultant, or partner â€” not a direct payment. That is why every serious framework treats third parties as a priority risk. [FCPA Resource Guide] [DOJ ECCP 2024] [UKBA Principle 4 â€” due diligence] [ISO 37001]

**The method in one sentence:** treat every third party as a *lifecycle to be managed*, with the depth of checking and the strength of safeguards always **proportionate to risk** â€” never the same form for everyone.

---

## 2. The lifecycle â€” seven phases

### Phase 1 â€” NEED (before you even search)
...
- What will they be paid for â€” and is the compensation connected to real, describable work?
- If the honest answer is "relationships" or "access," slow down: that answer is the beginning of most enforcement cases.
A third party without a clear, legitimate business purpose fails here â€” before any screening.

### Phase 2 â€” RISK CLASSIFICATION (the three inputs)
Before any due diligence, classify the risk. Three inputs decide the level:

| Input | Question | Examples |
|---|---|---|
| **A â€” Service type** | What will they do for us? | Distribution and sales (high) Â· technical supply (medium) Â· pure logistics (lower) â€” the more they represent you or touch decisions, the higher |
| **B â€” Geography** | Where will they act? | Use a recognized index (e.g., Corruption Perceptions Index) as a starting point: high-risk vs. low-risk countries |
| **C â€” Red flags** | What is already visible? | Public officials involved Â· unusual payment requests Â· incomplete documentation Â· foreign or third-party accounts Â· recommended by a customer or official |

A + B + C together set the **risk level**. This is judgment supported by structure â€” not a mechanical score. [practitioner method â€” Kruk; consistent with DOJ ECCP risk-based expectations]

### Phase 3 â€” RISK-TIERED DUE DILIGENCE (the escalation ladder)
The core of the method: **due diligence depth escalates with risk, and each tier ends in a validation gate.** Pass the gate â†’ proceed to contracting. Fail it â†’ escalate one tier up. At the top, some relationships are simply not entered.
...
- **BASIC** â€” everyone gets this: identity, registration, sanctions and watch-list screening, automated where possible.
- **STANDARD** â€” public and database information: ownership, adverse media, litigation, licenses.
- **ENHANCED I** â€” you now ask the third party itself: questionnaires, ownership declarations to natural persons, references, documents.
- **ENHANCED II** â€” you stop relying on what they tell you: an external specialized firm verifies independently (local records, site visits, reputation inquiries).
- **NO-GO** â€” if the highest tier cannot resolve the concerns, the answer is the answer. **Unverified is not the same as clean.** A relationship that cannot be verified is not entered â€” or goes to a formal, documented senior risk decision, never a quiet exception.

**Two rules of the ladder:**
1. **Risk can move a case UP at any time; it never moves DOWN silently.** A red flag discovered at STANDARD sends the case to ENHANCED â€” a good feeling never sends it back to BASIC.
...
### Phase 4 â€” CONTRACTING (safeguards scale with risk)
The contract is where due diligence findings become protections. Safeguards are cumulative â€” higher risk adds layers, it does not replace them:

| Risk tier | Contractual and program safeguards (cumulative) |
|---|---|
| All tiers | Anti-corruption and sanctions compliance clause Â· accurate books and records obligation Â· termination right for compliance breach |
| Standard and above | Compliance training or certification requirement Â· no sub-agents without approval Â· payment only to the contracting party, in the contract country |
| Enhanced tiers | Audit and information rights Â· ownership-change notification duty Â· re-screening triggers Â· enhanced payment controls |

The principle: **the same escalation logic that governed the checking now governs the protecting.** [practitioner method â€” Kruk; safeguard categories consistent with FCPA Guide and ISO 37001]

### Phase 5 â€” LIVING WITH THE THIRD PARTY (the longest phase, the most neglected)
Onboarding is not the end of due diligence â€” it is the start of monitoring:
- **Payments watch:** amounts, routes, payees, currencies â€” any change of payer or account is an event, not an administration detail.
- **Re-screening cadence** proportionate to risk (high-risk parties more often; and always against current lists â€” a screening result ages).
...
- **Behavior signals:** requests for unusual payment routes, vague invoices, pressure for speed, resistance to documentation â€” each is information.

### Phase 6 â€” RENEWAL AND CHANGE
...
### Phase 7 â€” EXIT AND AFTERLIFE (the phase almost nobody manages)
...
- **The afterlife:** outstanding invoices and receivables can still carry sanctions and corruption risk years later â€” even *collecting* money from a party whose status changed can be a prohibited act. Old third-party files must therefore be kept, and the party's status re-checked before any post-contract action.
- **Learning:** every exit â€” especially a bad one â€” feeds back into Phase 2: the risk model gets smarter with every relationship it has seen.

---

## 3. Ownership â€” who does what
...
- **Nobody owns permission to skip a gate.** Exceptions are formal, documented, senior risk decisions â€” never informal accommodations.

---

## 4. The five sentences to remember (for juniors)
1. The relationship starts before the contract and ends after it.
2. Checking depth follows risk â€” never one form for everyone.
...
**Sources:** [DOJ ECCP 2024 â€” third-party management and risk-based due diligence] Â· [FCPA Resource Guide â€” intermediary risk, safeguards] Â· [UK Bribery Act Guidance, Principle 4 â€” proportionate, risk-based due diligence] Â· [ISO 37001 â€” business-associate due diligence and controls] Â· escalation-ladder design, three-input classification, validation gates, lifecycle framing: **[practitioner method â€” Tomasz Kruk, 25 years multinational compliance practice]**. Source links: see `07_Research/Source_Register_v0.1.md`.

*Change log: v1.0.1 â€” added Source Register reference for verified links. v1.0 â€” initial lecture version; fresh expression of the escalation model with lifecycle extension (Phases 1 and 5â€“7 added around the original ladder).*
...
# Training Design Schema â€” The Kruk Method
**Purpose:** the standard structure for designing ALL compliance trainings in ACI-OS â€” any topic, any audience. Part B applies it to the first case: third-party due diligence training for commercial teams.
**Repo:** `04_Methodology/Training_Design_Schema_Kruk_v1.0.md` Â· **Elements:** E4 (Training & Communication), applied here with E3/E2 content.
**Language rule:** plain language, no idioms, translation-ready â€” trainings are consumed by non-native speakers under time pressure.

---

## PART A â€” THE UNIVERSAL SCHEMA (10 steps, in this order)

**The design principle behind the order:** adults learn when they first see WHY it matters to them, then face realistic decisions â€” never when policy text is read to them. Cases come first; rules come after the audience already cares. [adult-learning research; DOJ ECCP 2024 â€” risk-based, tailored training; practitioner method â€” Kruk]

### Step 1 â€” TARGET: who exactly, and what risk
- Define the audience by role and by the risks THEY actually touch (commercial team â‰  finance â‰  HR).
...
### Step 2 â€” OBJECTIVE: three behaviors, not knowledge
...
### Step 3 â€” HOOK: a real case, first slide, no introduction
- Open with a true story from THEIR world â€” an enforcement case, an anonymized industry disaster, a pattern they recognize.
- No agenda slide, no legal framework, no definitions. The story creates the question the training answers.
- The case must contain a person they can identify with â€” someone doing their job under normal pressure.

### Step 4 â€” STAKES: what it costs, personally and for the company
- Consequences in this order: (1) what happened to the PEOPLE in the case (career, personal liability, criminal exposure), (2) what happened to the company (fines, lost deals, banking problems, reputational damage), (3) what happened to the business â€” deals died, markets closed.
- Numbers make it real: actual fine amounts, actual prison terms, actual deal values lost.
- One honest sentence about detection: "these cases start with an audit, a competitor complaint, a whistleblower, or a bank â€” never at a convenient moment."

### Step 5 â€” THE RULES: minimum viable, three to five, plain language
- Only now the rules â€” and only the 3â€“5 that this audience must actually live by.
...
### Step 6 â€” THE GRAY ZONE: scenarios from their daily reality
- 2â€“4 scenarios built from situations THIS audience genuinely faces â€” with realistic pressure, incomplete information, and tempting wrong answers built in.
- Every scenario needs: context and characters they recognize Â· a real decision point Â· plausible wrong options (the mistakes people actually make, not obvious villains) Â· time pressure or authority pressure as an ingredient.
- Gray beats black-and-white: the training exists for the situations where the answer is NOT obvious.

### Step 7 â€” PRACTICE: they decide, then see consequences
- Participants choose what they would do â€” vote, discuss, commit â€” BEFORE the answer is revealed.
...
### Step 8 â€” RED FLAGS AND THE CALL: what to spot, whom to contact
- The audience-specific red-flag list: the 5â€“8 signals THEY are positioned to see first.
...
### Step 9 â€” TAKEAWAY: the one-page card
- One page (physical or digital): the 3â€“5 rules Â· the red flags Â· the contact.
- If it does not fit on one page, the training tried to teach too much. The card is what survives the room.

### Step 10 â€” MEASURE AND REINFORCE: behavior, not completion
- Completion rates prove attendance, not effectiveness. Measure behavior: questions and consultations arriving AFTER the training Â· early involvement rate Â· disclosures made Â· red flags reported.
...
- WHY before WHAT, always â€” adults reject rules whose purpose they cannot see.
- Their world, their words â€” generic scenarios teach nothing; recognizable ones are remembered.
- 45â€“60 minutes live, or 3 Ã— 15-minute micro-modules. Attention is a budget.
...
## PART B â€” APPLIED: DUE DILIGENCE TRAINING FOR THE COMMERCIAL TEAM (60 minutes)

**Step 1 â€” Target:** commercial/sales team of an international company; they source and manage third parties (agents, distributors, resellers, consultants) and feel DD as friction.
**Step 2 â€” Objectives (three behaviors):** after this training, the commercial team will (1) involve Compliance BEFORE any commitment to a new third party, (2) recognize and report the eight commercial red flags, (3) never promise, sign, pay, or announce before the DD gate is passed.

**Step 3 â€” Hook (minutes 0â€“8): "The perfect agent."**
A commercial director in a growth market finds the ideal local agent: well-connected, recommended by the customer's own procurement head, ready to start immediately, asking only a success fee. Nine months later: the agent's "connections" turn out to include the officials deciding the tender; payments went to a third-country account; the company is under investigation in two jurisdictions; the director â€” who did nothing but close deals the way everyone wanted â€” spends two years as a witness and suspect. The deal that made the year destroyed the next three.
*(Pattern-based composite; every element from real enforcement patterns.)*

**Step 4 â€” Stakes (minutes 8â€“15):**
- For the people: careers ended for commercial staff who "only made the introduction" Â· personal criminal exposure exists in most jurisdictions Â· being a witness for two years is a punishment nobody sentences you to.
- For the company: fines in the hundreds of millions in comparable cases Â· debarment from public tenders Â· banks terminating relationships.
- For the business â€” the argument that lands with sales: **deals with skipped DD die later and die expensively** â€” unwind costs, frozen payments, terminated contracts. Early DD is deal protection, not deal prevention.

**Step 5 â€” The five rules (minutes 15â€“22):**
1. **Bring the third party to Compliance BEFORE any commitment** â€” before the handshake email, before the LOI, before the announcement. Early = fast; late = slow or dead.
2. **Never promise what is not yet cleared** â€” no "consider it done," no "the check is a formality."
3. **You are the eyes** â€” you meet these partners; Compliance only reads about them. What you see and hear IS the due diligence.
4. **The payment route is part of the deal** â€” any request for a different payee, country, account, or structure goes to Compliance the same day, untouched.
5. **A recommendation is not a clearance** â€” least of all from the customer, an official, or a board member. The warmer the recommendation, the more it must be checked.

**Step 6 â€” Gray-zone scenarios (minutes 22â€“45), three, each ~7 minutes:**
- **Scenario 1 â€” "The customer's friend":** your key customer's procurement head recommends a local consultant "to make cooperation smoother." He is charming, credentialed, and cheap. What do you do â€” and what do you say to the customer without damaging the relationship? *(Teaches rules 1, 5; the pressure is relational.)*
- **Scenario 2 â€” "Friday, 17:00":** the deal closes Monday; the distributor's DD questionnaire is incomplete â€” ownership section blank, "our lawyer is on vacation." Your manager says "we cannot lose this over paperwork." Options on the table â€” including the tempting wrong ones. *(Teaches rules 1, 2; the pressure is time + hierarchy.)*
- **Scenario 3 â€” "Small change":** a long-standing, fully cleared agent asks that this quarter's commission go to their "group treasury company" in another country. Same group, they say. It is a two-line email â€” forward to finance, or something else? *(Teaches rule 4; the pressure is routine and smallness.)*

**Step 7 â€” Practice:** for each scenario, the room votes before discussion; wrong answers are explored, not shamed â€” "what made option B tempting?" is the actual lesson.

**Step 8 â€” Red flags and the call (minutes 45â€“55):** the commercial eight â€” recommendation by customer or official Â· vague services ("relationship management," "market access") Â· success-fee-only compensation Â· third-party or third-country payment requests Â· refusal or delay on ownership information Â· urgency as a pressure tool Â· "everyone works this way here" Â· requests to keep arrangements informal or undocumented. Then the promise: one contact, first answer within 24 hours, asking early is rewarded â€” and it makes deals FASTER.

**Step 9 â€” The card:** one page â€” five rules, eight red flags, one contact. Handed out physically; it lives in the laptop bag.

**Step 10 â€” Measure:** consultations arriving before commitment (the target metric) Â· red flags reported per quarter Â· post-training questions (recurring confusion = next quarter's 15-minute micro-scenario) Â· deal-cycle time on cleared third parties (to prove the speed promise true).

---

**Sources:** [DOJ ECCP 2024 â€” risk-based, tailored training; effectiveness measurement beyond completion] Â· [UKBA Principle 5 â€” communication and training proportionate to risk] Â· [ISO 37301 â€” training and awareness requirements] Â· [adult-learning and scenario-based-learning research â€” why-first framing, realistic scenarios with plausible failure, behavior-change measurement, micro-reinforcement] Â· schema order (caseâ†’stakesâ†’rulesâ†’gray zoneâ†’practiceâ†’cardâ†’behavior metrics), the five commercial rules, the commercial eight red flags, the "deal protection, not deal prevention" framing: **[practitioner method â€” Tomasz Kruk]**.

*Change log: v1.0 â€” initial schema + first application (commercial DD training).*
